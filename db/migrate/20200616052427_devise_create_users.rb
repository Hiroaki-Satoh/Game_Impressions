...
class DeviseCreateUsers < ActiveRecord::Migration[5.2]
  def change
    create_table :users do |t|
      ...
      t.string  :icon_image_id                              # アイコン画像
      t.text    :introduction                               # 自己紹介文
      t.integer :level,         null: false, default: 1     # ユーザのレベル（いいねの数で上昇させる）
      t.boolean :is_valid,      null: false, default: true  # 退会しているかどうか（退会した場合は、falseに変更）
      # ここまで
